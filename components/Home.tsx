    ...
    <>
      ...
      <div className="relative h-[calc(100vh-5rem)] flex items-center justify-center text-white text-center p-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl animate-fade-in-up bg-black/50 md:bg-transparent p-6 md:p-0 rounded-xl backdrop-blur-xs md:backdrop-blur-none">
          <h1 className="text-4xl md:text-6xl font-hooligan uppercase tracking-wider" style={{ textShadow: '0 0 15px #facc15, 0 0 25px #facc15' }}>
            {t('home.slogan')}
          </h1>
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
       ...
       {/* Final CTA Section */}
      <section className="py-20 bg-gray-800 dark:bg-gray-900 text-white text-center" style={{backgroundImage: `url('https://www.transparenttextures.com/patterns/dark-matter.png')`}}>
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-hooligan uppercase tracking-wider mb-4" style={{ textShadow: '0 0 15px #facc15' }}>{t('home.final_cta_title')}</h2>
